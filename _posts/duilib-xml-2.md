---
title: 网易duilib中的xml解析（二）WindowBuilder
date: 2020-05-08 21:23:01
categories: duilib
tags: 
    - duilib
    - VC
description: 主要讨论duilib库如何在标准xml语法上做特化
---
[上文](https://howsonliu.github.io/2020/05/04/duilib-xml-1/)介绍了网易duilib是如何通过`CMarkup`支持标准xml语法的，本文主要介绍duilib特化
